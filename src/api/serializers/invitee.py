...
async def notification_email(invitee: Invitee, site: Site):
    ...
    message = (
        ...
        f"{organization.formatted_name} vous invite à créer un compte sur le nouveau "
        ...
        f"Il n'est pas nécessaire de créer une adresse Gmail, votre mail habituel "
        f"{invitee.email} est suffisant.\n\n"
