...
def get_uid_query(uid: str):
    return f"""
        ...
        RETURN entry,et,e,rel,f,c,country,tpp,COLLECT(DISTINCT pm) AS pm,convention,COLLECT(DISTINCT a) AS a,DISTINCT label AS typelabels,COLLECT(DISTINCT memberships) as memberships;"""
