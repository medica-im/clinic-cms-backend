...
def get_uid_query(uid: str):
    return f"""
        ...
        RETURN entry,et,e,rel,f,c,country,COLLECT(DISTINCT tpp) AS tpp,COLLECT(DISTINCT pm) AS pm,convention,COLLECT(DISTINCT a) AS a,collect(DISTINCT label) AS typelabels,COLLECT(DISTINCT memberships) as memberships;"""
