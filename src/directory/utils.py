...
def get_entries(
    ...
    if uid:
        ...
        WITH entry, e, et, f, commune, dpt, country, entry, COLLECT(DISTINCT membership) as memberships
        OPTIONAL MATCH (entry:Entry)-[:EMPLOYER]->(employer:Entry)
        WITH entry, e, et, f, commune, dpt, country, memberships, entry, COLLECT(DISTINCT employer) as employers
